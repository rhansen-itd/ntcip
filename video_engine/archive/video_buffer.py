...
class VideoBufferManager:
    ...
    def _log_discrepancy_to_csv(self, trigger: dict, video_path: Path) -> None:
        ...
        event timestamp to a human-readable local timezone string. Fast append
        operation safe for the main polling loop.
        ...
        # Convert UTC epoch to local human-readable time
        try:
